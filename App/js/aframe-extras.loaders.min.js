            ...
            parse: function(e, t) {
                    ...
                    !(function(e, t) {
                      for (
                        ...
                        var u = r[c],
                          d = u.time,
                          f = u.value;
                        Y.fromArray(f).transpose(),
                          Y.decompose(K, J, Z),
                          n.push(d),
                          i.push(K.x, K.y, K.z),
                          o.push(J.x, J.y, J.z, J.w),
                          s.push(Z.x, Z.y, Z.z);
                      }
                      i.length > 0 &&
                        t.push(
                      ...
                      s.length > 0 &&
                        t.push(
                          new THREE.VectorKeyframeTrack(a + ".scale", n, s)
                        );
                    })(
                      (function(e, t, r) {
                        var a,
                        ...
                        var v = (function(e, t) {
                          var r = [];
                          for (var a in e)
                            r.push({ time: parseFloat(a), value: e[a] });
                          r.sort(function(e, t) {
                        ...
                        return { name: u.uuid, keyframes: v };
                      })(o, n[c], n[l]),
                      t
                    );
                  }
              ...
              function h(e) {
                for (
                  ...
                  for (var s = p(n[i]), c = 0, l = s.length; c < l; c++)
                    t.push(s[c]);
                  ...
                  void 0 !== e.skin &&
                    ((t.skin = (function(e) {
                      ...
                      for (r = 0, n = c.length; r < n; r++) {
                        ...
                        for (a = 0; a < v; a++) {
                          var E = l[m + u],
                            y = l[m + d],
                            b = h[y];
                          g.push({ index: E, weight: b }), (m += 2);
                        }
                        for (g.sort(t), a = 0; a < 4; a++) {
                          var T = g[a];
                          void 0 !== T
                            ? (i.indices.array.push(T.index),
                              i.weights.array.push(T.weight))
                            : (i.indices.array.push(0),
                              i.weights.array.push(0));
                        }
                      }
                      e.bindShapeMatrix
                      ...
                      for (r = 0, n = f.array.length; r < n; r++) {
                        var w = f.array[r],
                          R = new THREE.Matrix4()
                            .fromArray(p.array, r * p.stride)
                            .transpose();
                        i.joints.push({ name: w, boneInverse: R });
                      }
                      return i;
                    })(e.skin)),
              ...
              function w(e) {
                      ...
                      if (
                        ...
                        (i.wrapS = s.wrapU
                          ...
                          (i.wrapT = s.wrapV
                            ? THREE.RepeatWrapping
                            : THREE.ClampToEdgeWrapping),
                          i.offset.set(s.offsetU || 0, s.offsetV || 0),
                          i.repeat.set(s.repeatU || 1, s.repeatV || 1);
                      } else
                ...
                var u = o.transparent,
                  f = o.transparency;
                if (
                  (void 0 === f && u && (f = { float: 1 }),
                  void 0 === u &&
                    f &&
                    (u = { opaque: "A_ONE", data: { color: [1, 1, 1, 1] } }),
                  u && f)
                )
                  ...
                  if (1 === o.nodeType)
                    switch (o.nodeName) {
                      ...
                      case "technique_common":
                        ...
                        void 0 !== s &&
                          (t.stride = parseInt(s.getAttribute("stride")));
                    }
                }
                return t;
              }
                  ...
                  I(s),
                    (t[o] = (function(e, t, r) {
                        ...
                        for (var b in v) {
                          ...
                          switch (b) {
                            case "VERTEX":
                              for (var w in r) {
                                ...
                                switch (w) {
                                  case "POSITION":
                                    ...
                                    if (
                                      (L(m, t[R], T.offset, n.array),
                                      (n.stride = t[R].stride),
                                      t.skinWeights &&
                                        t.skinIndices &&
                                        (L(m, t.skinIndices, T.offset, l.array),
                                        L(m, t.skinWeights, T.offset, u.array)),
                                      !1 === m.hasUV && !0 === e.uvsNeedsFix)
                                    )
                                      for (
                                        var g = (n.array.length - x) / n.stride,
                                          A = 0;
                                        A < g;
                                        A++
                                      )
                                    ...
                                    break;
                                  case "NORMAL":
                                    L(m, t[R], T.offset, i.array),
                                      (i.stride = t[R].stride);
                                    break;
                                  case "COLOR":
                                    L(m, t[R], T.offset, c.array),
                                      (c.stride = t[R].stride);
                                    break;
                                  case "TEXCOORD":
                                    L(m, t[R], T.offset, o.array),
                                      (o.stride = t[R].stride);
                                    break;
                                  case "TEXCOORD1":
                                    L(m, t[R], T.offset, s.array),
                                      (o.stride = t[R].stride);
                                    break;
                                  default:
                                    console.warn(
                              ...
                              break;
                            case "NORMAL":
                              L(m, t[T.id], T.offset, i.array),
                                (i.stride = t[T.id].stride);
                              break;
                            case "COLOR":
                              L(m, t[T.id], T.offset, c.array),
                                (c.stride = t[T.id].stride);
                              break;
                            case "TEXCOORD":
                              L(m, t[T.id], T.offset, o.array),
                                (o.stride = t[T.id].stride);
                              break;
                            case "TEXCOORD1":
                              L(m, t[T.id], T.offset, s.array),
                      ...
                      u.array.length > 0 &&
                        d.addAttribute(
                          "skinWeight",
                          new THREE.Float32BufferAttribute(u.array, u.stride)
                        );
                      return (
                        (a.data = d),
                        (a.type = e[0].type),
              ...
              function L(e, t, r, a) {
                ...
                else for (var d = 0, f = i.length; d < f; d += o) n(d);
              }
              function M(e) {
                ...
                for (
                  ...
                  if (1 === a.nodeType)
                    switch (a.nodeName) {
                      ...
                      case "matrix":
                        i = n(a.textContent);
                        t.matrix.multiply(Y.fromArray(i).transpose()),
                          (t.transforms[a.getAttribute("sid")] = a.nodeName);
                        break;
                      case "translate":
                        i = n(a.textContent);
                        $.fromArray(i),
                          t.matrix.multiply(Y.makeTranslation($.x, $.y, $.z)),
                          (t.transforms[a.getAttribute("sid")] = a.nodeName);
                        break;
                      case "rotate":
                        ...
                        t.matrix.multiply(
                          Y.makeRotationAxis($.fromArray(i), s)
                        ),
                          (t.transforms[a.getAttribute("sid")] = a.nodeName);
                        break;
                      case "scale":
                        i = n(a.textContent);
                        t.matrix.scale($.fromArray(i)),
                          (t.transforms[a.getAttribute("sid")] = a.nodeName);
                        break;
                      case "extra":
                        break;
              ...
              function j(e, t) {
                ...
                for (r = 0; r < e.length; r++) {
                  ...
                  if (X(o)) _(q(o), t, n);
                    ...
                    for (
                      var s = ce.visualScenes[o].children, c = 0;
                      c < s.length;
                      c++
                    ) {
                      var l = s[c];
                ...
                for (r = 0; r < n.length; r++)
                  !1 === (a = n[r]).processed &&
                    (i.push(a), (a.processed = !0));
                var u = [],
                  d = [];
                for (r = 0; r < i.length; r++)
                  (a = i[r]), u.push(a.bone), d.push(a.boneInverse);
              ...
              function U(e) {
                ...
                for (var u = 0, d = o.length; u < d; u++)
                  for (
                    var p = g((b = o[u]).id),
                      h = G((T = M(p.id)), b.materials),
                      m = j(b.skeletons, p.skin.joints),
                      v = 0,
                      E = h.length;
                    v < E;
                    v++
                ...
                return (
                  "" === w.name && (w.name = "JOINT" === n ? e.sid : e.name),
                  w.matrix.copy(r),
              ...
              function G(e, t) {
                ...
                for (var a in e) {
                  ...
                  switch (a) {
                    ...
                    case "polylist":
                      l = o
                        ? new THREE.SkinnedMesh(n.data, u)
                        : new THREE.Mesh(n.data, u);
                  }
                  r.push(l);
                }
                return r;
              ...
              var K = new THREE.Vector3(),
                ...
                Y = new THREE.Matrix4(),
                $ = new THREE.Vector3(),
                Q = new THREE.MeshBasicMaterial({ color: 16711935 });
              ...
              ae.setPath(this.resourcePath || t).setCrossOrigin(
                this.crossOrigin
              );
              var ne;
              THREE.TGALoader &&
                (ne = new THREE.TGALoader(this.manager)).setPath(
                  this.resourcePath || t
                );
              var ie = [],
                oe = {},
                        ...
                        (i = n.getAttribute("target")),
                          (t.channels[i] = (function(e) {
                            ...
                            return (
                              ...
                              (t.arraySyntax = i),
                              (t.memberSyntax = s),
                              (t.sampler = o(e.getAttribute("source"))),
                              t
                            );
                          })(n));
                        break;
                    ...
                    if (1 === i.nodeType)
                      switch (i.nodeName) {
                        case "technique_common":
                          t = (function(e) {
                            for (
                              var t = {}, r = 0, a = e.childNodes.length;
                              r < a;
                              r++
                            ) {
                              var i = e.childNodes[r];
                          ...
                          !(function(e, t) {
                            for (var r = 0; r < e.childNodes.length; r++) {
                              ...
                              if (1 === a.nodeType)
                                switch (a.nodeName) {
                                  case "joint":
                                    t.joints[a.getAttribute("sid")] = (function(
                                      e
                                    ) {
                                      for (
                                        var t, r = 0;
                  ...
                  if (!0 === c(e)) {
                    if (!1 === c(ce.animations)) {
                      ...
                      for (var r in ce.animations)
                        for (var a = p(r), n = 0, i = a.length; n < i; n++)
                          t.push(a[n]);
                      ie.push(new THREE.AnimationClip("default", -1, t));
                    }
                  } else for (var r in e) ie.push(m(r));
                })(),
                (function() {
                  function e(e, t) {
              ...
              var le = (function(e) {
                return z(
                  o(r(e, "instance_visual_scene")[0].getAttribute("url"))
                );
              })(r(ee, "scene")[0]);
              return (
                "Z_UP" === re.upAxis &&
                ...
                le.scale.multiplyScalar(re.unit),
                { animations: ie, kinematics: oe, library: ce, scene: le }
              );
            }
          });
      },
      ...
      function(e, t, r) {
        ...
        t.exports = THREE.FBXLoader = (function() {
          ...
          function f(e) {
            ...
            if (
              (e.translation && x.fromArray(e.translation),
              e.rotationOffset && x.add(R.fromArray(e.rotationOffset)),
              e.rotation)
            ) {
              (a = e.rotation.map(THREE.Math.degToRad)).push(r),
                A.makeRotationFromEuler(w.fromArray(a));
            }
            if (e.preRotation) {
              (a = e.preRotation.map(THREE.Math.degToRad)).push(r),
                T.makeRotationFromEuler(w.fromArray(a)),
                A.premultiply(T);
            }
            if (e.postRotation) {
            ...
            return (
              e.scale && t.scale(R.fromArray(e.scale)),
              t.setPosition(x),
              t.multiply(A),
              t
            );
          ...
          (e.prototype = {
            ...
            (t.prototype = {
              ...
              parseConnections: function() {
                ...
                if ("Connections" in g) {
                  g.Connections.connections.forEach(function(t) {
                    ...
                    var i = { ID: a, relationship: n };
                    e.get(r).parents.push(i),
                      e.has(a) || e.set(a, { parents: [], children: [] });
                    var o = { ID: r, relationship: n };
              ...
              parseImages: function() {
                ...
                if ("Video" in g.Objects) {
                  ...
                  for (var a in r) {
                    ...
                    if (
                      ((e[(c = parseInt(a))] =
                        n.RelativeFilename || n.Filename),
                      "Content" in n)
                    ) {
                      var i =
                          n.Content instanceof ArrayBuffer &&
              ...
              parseTexture: function(e, t) {
                ...
                if (
                  ((r.wrapS =
                    0 === i ? THREE.RepeatWrapping : THREE.ClampToEdgeWrapping),
                  (r.wrapT =
              ...
              loadTexture: function(e, t) {
                var r,
                  a = this.textureLoader.path,
                  n = E.get(e.id).children;
                void 0 !== n &&
                  n.length > 0 &&
                  void 0 !== t[n[0].ID] &&
                  ((0 !== (r = t[n[0].ID]).indexOf("blob:") &&
                    0 !== r.indexOf("data:")) ||
                    this.textureLoader.setPath(void 0));
                var i,
                  o = e.FileName.slice(-3).toLowerCase();
                if ("tga" === o) {
              ...
              parseParameters: function(e, t, r) {
                ...
                e.BumpFactor && (a.bumpScale = e.BumpFactor.value),
                  e.Diffuse
                    ? (a.color = new THREE.Color().fromArray(e.Diffuse.value))
                    : e.DiffuseColor &&
                  ...
                  e.Specular
                    ? (a.specular = new THREE.Color().fromArray(
                        e.Specular.value
                      ))
                    : e.SpecularColor &&
                ...
                var n = this;
                return (
                  E.get(r).children.forEach(function(e) {
                    ...
                    switch (r) {
                      ...
                      case "TransparentColor":
                        (a.alphaMap = n.getTexture(t, e.ID)),
                          (a.transparent = !0);
                        break;
                      case "AmbientColor":
                  ...
                  for (var a in r) {
                    ...
                    if ("Skin" === n.attrType) {
                      ...
                      (o.ID = a),
                        ...
                        (o.geometryID = i.parents[0].ID),
                        (e[a] = o);
                    } else if ("BlendShape" === n.attrType) {
                      var s = { id: a };
                      (s.rawTargets = this.parseMorphTargets(i, r)),
                        (s.id = a),
                        i.parents.length > 1 &&
                          console.warn(
                ...
                return (
                  e.children.forEach(function(e) {
                    ...
                    if ("Cluster" === a.attrType) {
                      ...
                      "Indexes" in a &&
                        ((n.indices = a.Indexes.a), (n.weights = a.Weights.a)),
                        r.push(n);
                    }
                  }),
                  { rawBones: r, bones: [] }
              ...
              parseScene: function(e, t, r) {
                ...
                n.forEach(function(e) {
                  ...
                  this.bindSkeleton(e.skeletons, t, n),
                  this.createAmbientLight(),
                  this.setupMorphMaterials();
                var s = new a().parse();
                1 === y.children.length &&
                  y.children[0].isGroup &&
                  ((y.children[0].animations = s), (y = y.children[0])),
                  (y.animations = s);
              },
                      ...
                      o.rawBones.forEach(function(t, i) {
                        if (t.ID === e.ID) {
                          ...
                          (n = new THREE.Bone()).matrixWorld.copy(
                            ...
                            (n.name = THREE.PropertyBinding.sanitizeNodeName(
                              a
                            )),
                            (n.ID = r),
                            (o.bones[i] = n),
              ...
              createCamera: function(e) {
                ...
                if (
                  ...
                  void 0 !== r.AspectWidth &&
                    ...
                    ((o = r.AspectWidth.value), (s = r.AspectHeight.value));
                  var c = o / s,
                    l = 45;
                  ...
                  switch (a) {
                    case 0:
                      (t = new THREE.PerspectiveCamera(l, c, n, i)),
                    ...
                    default:
                      console.warn(
                        "THREE.FBXLoader: Unknown camera type " + a + "."
                      ),
                        (t = new THREE.Object3D());
                  }
                }
              ...
              createLight: function(e) {
                ...
                if (
                  ...
                  var n = 16777215;
                  void 0 !== r.Color &&
                    (n = new THREE.Color().fromArray(r.Color.value));
                  ...
                  switch (a) {
                    ...
                    case 2:
                      var s = Math.PI / 3;
                      void 0 !== r.InnerAngle &&
                        (s = THREE.Math.degToRad(r.InnerAngle.value));
                      var c = 0;
                      void 0 !== r.OuterAngle &&
                        ((c = THREE.Math.degToRad(r.OuterAngle.value)),
                        (c = Math.max(c, 1))),
                        (t = new THREE.SpotLight(n, i, o, s, c, 1));
                      break;
                    default:
                      console.warn(
                ...
                return (
                  e.children.forEach(function(e) {
                    t.has(e.ID) && (n = t.get(e.ID)),
                      r.has(e.ID) && o.push(r.get(e.ID));
                  }),
                  o.length > 1
                    ? (i = o)
                    : o.length > 0
                    ? (i = o[0])
                    : ((i = new THREE.MeshPhongMaterial({ color: 13421772 })),
                      o.push(i)),
              ...
              setModelTransforms: function(e, t) {
                ...
                "RotationOrder" in t &&
                  ...
                  "PostRotation" in t &&
                    (r.postRotation = t.PostRotation.value),
                  ...
                  E.get(e.ID).children.forEach(function(t) {
                    if ("LookAtProperty" === t.relationship) {
                      ...
                      if ("Lcl_Translation" in r) {
                        ...
                        void 0 !== e.target
                          ? (e.target.position.fromArray(a), y.add(e.target))
                          : e.lookAt(new THREE.Vector3().fromArray(a));
                      }
                    }
                  });
                }
                  ...
                  for (var r in t)
                    if ("BindPose" === t[r].attrType) {
                      ...
                      Array.isArray(a)
                        ...
                        : (e[a.Node] = new THREE.Matrix4().fromArray(
                            a.Matrix.a
                          ));
                    }
                }
                ...
                y.traverse(function(e) {
                  if (
                    ...
                    y.traverse(function(e) {
                      ...
                      !0 === a && (e.material = e.material.clone()),
            ...
            (r.prototype = {
              ...
              genGeometry: function(e, t, r, a) {
                ...
                if (
                  ...
                  t &&
                    (n.addAttribute(
                      "skinIndex",
                      new THREE.Uint16BufferAttribute(o.weightsIndices, 4)
                    ),
                    n.addAttribute(
                      "skinWeight",
                      new THREE.Float32BufferAttribute(o.vertexWeights, 4)
                    ),
                    (n.FBX_Deformer = t)),
                  o.normal.length > 0)
                ) {
                ...
                if (
                  (o.uvs.forEach(function(e, t) {
                    ...
                    0 === t && (r = "uv"),
                      n.addAttribute(
                        r,
                        new THREE.Float32BufferAttribute(o.uvs[t], 2)
                      );
                  }),
                  ...
                  var l = o.materialIndex[0],
                    u = 0;
                  if (
                    (o.materialIndex.forEach(function(e, t) {
                    ...
                    var d = n.groups[n.groups.length - 1],
                      f = d.start + d.count;
                    f !== o.materialIndex.length &&
                      n.addGroup(f, o.materialIndex.length - f, l);
                  }
                  0 === n.groups.length &&
                    n.addGroup(0, o.materialIndex.length, o.materialIndex[0]);
                }
              ...
              parseGeoNode: function(e, t) {
                ...
                if (
                  ...
                  r.uv = [];
                  for (var a = 0; e.LayerElementUV[a]; )
                    r.uv.push(this.parseUVs(e.LayerElementUV[a])), a++;
                }
                return (
                  (r.weightTable = {}),
                  null !== t &&
                    ...
                    t.rawBones.forEach(function(e, t) {
                      e.indices.forEach(function(a, n) {
                        void 0 === r.weightTable[a] && (r.weightTable[a] = []),
                          r.weightTable[a].push({
                            id: t,
                            weight: e.weights[n]
                          });
                      });
              ...
              genBuffers: function(e) {
                var t = {
                  ...
                  f = this;
                return (
                  e.vertexIndices.forEach(function(p, h) {
                    var m = !1;
                    p < 0 && ((p ^= -1), (m = !0));
                    var v = [],
                      g = [];
              ...
              genFace: function(e, t, r, a, n, i, o, s, c, l) {
                for (var u = 2; u < l; u++)
                  e.vertex.push(t.vertexPositions[r[0]]),
                    ...
                    e.vertex.push(t.vertexPositions[r[3 * (u - 1)]]),
                    e.vertex.push(t.vertexPositions[r[3 * (u - 1) + 1]]),
                    e.vertex.push(t.vertexPositions[r[3 * (u - 1) + 2]]),
                    e.vertex.push(t.vertexPositions[r[3 * u]]),
                    e.vertex.push(t.vertexPositions[r[3 * u + 1]]),
                    e.vertex.push(t.vertexPositions[r[3 * u + 2]]),
                    t.skeleton &&
                      ...
                      e.weightsIndices.push(c[4 * (u - 1) + 1]),
                      e.weightsIndices.push(c[4 * (u - 1) + 2]),
                      e.weightsIndices.push(c[4 * (u - 1) + 3]),
                    ...
                    t.color &&
                      ...
                      e.colors.push(i[1]),
                      e.colors.push(i[2]),
                      e.colors.push(i[3 * (u - 1)]),
                      e.colors.push(i[3 * (u - 1) + 1]),
                      e.colors.push(i[3 * (u - 1) + 2]),
                      e.colors.push(i[3 * u]),
                      e.colors.push(i[3 * u + 1]),
                      e.colors.push(i[3 * u + 2])),
                    t.material &&
                      "AllSame" !== t.material.mappingType &&
                      (e.materialIndex.push(a),
                      e.materialIndex.push(a),
                      e.materialIndex.push(a)),
                    t.normal &&
                      (e.normal.push(n[0]),
                      e.normal.push(n[1]),
                      e.normal.push(n[2]),
                      e.normal.push(n[3 * (u - 1)]),
                      e.normal.push(n[3 * (u - 1) + 1]),
                      e.normal.push(n[3 * (u - 1) + 2]),
                      e.normal.push(n[3 * u]),
                      e.normal.push(n[3 * u + 1]),
                      e.normal.push(n[3 * u + 2])),
                    t.uv &&
                      t.uv.forEach(function(t, r) {
                        void 0 === e.uvs[r] && (e.uvs[r] = []),
                          e.uvs[r].push(o[r][0]),
                          e.uvs[r].push(o[r][1]),
                          e.uvs[r].push(o[r][2 * (u - 1)]),
                          e.uvs[r].push(o[r][2 * (u - 1) + 1]),
                          e.uvs[r].push(o[r][2 * u]),
                          e.uvs[r].push(o[r][2 * u + 1]);
                      });
              },
              ...
              genMorphGeometry: function(e, t, r, a) {
                ...
                for (
                  var i =
                      void 0 !== t.PolygonVertexIndex
                        ...
                        : [],
                    o = void 0 !== t.Vertices ? t.Vertices.a.slice() : [],
                    s = void 0 !== r.Vertices ? r.Vertices.a : [],
                    c = void 0 !== r.Indexes ? r.Indexes.a : [],
                    l = 0;
                  l < c.length;
                  l++
                ) {
                ...
                var d = { vertexIndices: i, vertexPositions: o },
                  f = this.genBuffers(d),
                  p = new THREE.Float32BufferAttribute(f.vertex, 3);
                (p.name = r.attrName),
                  a.applyToBufferAttribute(p),
              ...
              parseMaterialIndices: function(e) {
                ...
                for (var a = e.Materials.a, n = [], i = 0; i < a.length; ++i)
                  n.push(i);
                return {
                  dataSize: 1,
                  buffer: a,
              ...
              parseNurbsGeometry: function(e) {
                ...
                for (
                  ...
                  n.push(new THREE.Vector4().fromArray(i, o));
                var c, l;
                ...
                var u = new THREE.NURBSCurve(r, a, n, c, l).getPoints(
                    7 * n.length
                  ),
                ...
                return (
                  f.addAttribute("position", new THREE.BufferAttribute(d, 3)), f
                );
              }
            }),
            (a.prototype = {
              ...
              parseAnimationCurveNodes: function() {
                ...
                for (var r in e) {
                  ...
                  if (null !== a.attrName.match(/S|R|T|DeformPercent/)) {
                    var n = { id: a.id, attr: a.attrName, curves: {} };
                    t.set(n.id, n);
                  }
                }
                return t;
                      ...
                      if (e.has(t.ID)) {
                        ...
                        if (
                          ...
                          if (void 0 === n[r]) {
                            ...
                            "PreRotation" in i &&
                              (s.preRotations = i.PreRotation.value),
                              "PostRotation" in i &&
                                (s.postRotations = i.PostRotation.value),
                              (n[r] = s);
                          }
                          n[r][a.attr] = a;
              ...
              generateTracks: function(e) {
                var t = [],
                  ...
                  n = new THREE.Vector3();
                if (
                  (e.transform && e.transform.decompose(r, a, n),
                  (r = r.toArray()),
                  (a = new THREE.Euler().setFromQuaternion(a).toArray()),
                  (n = n.toArray()),
                  void 0 !== e.T && Object.keys(e.T.curves).length > 0)
                ) {
                  var i = this.generateVectorTrack(
                    e.modelName,
                    e.T.curves,
                    r,
                    "position"
              ...
              generateRotationTrack: function(e, t, r, a, n) {
                ...
                void 0 !== a &&
                  ((a = a.map(THREE.Math.degToRad)).push("ZYX"),
                  (a = new THREE.Euler().fromArray(a)),
                ...
                for (
                  ...
                  c.set(o[u], o[u + 1], o[u + 2], "ZYX"),
                    s.setFromEuler(c),
                    void 0 !== a && s.premultiply(a),
                    void 0 !== n && s.multiply(n),
                    s.toArray(l, (u / 3) * 4);
              ...
              generateMorphTrack: function(e) {
                var t = e.DeformPercent.curves.morph,
                  ...
                  a = y.getObjectByName(e.modelName).morphTargetDictionary[
                    e.morphName
                  ];
                return new THREE.NumberKeyframeTrack(
                  e.modelName + ".morphTargetInfluences[" + a + "]",
                  t.times,
                  r
                );
              },
                ...
                for (var t = 1; t < e.values.length; t++) {
                  ...
                  if (n >= 180) {
                    for (
                      ...
                      d.push(u), (u += l), f.push(s), (s += o);
                    (e.times = v(e.times, t, d)),
                      (e.values = v(e.values, t, f));
                  }
                }
              }
            }),
            (i.prototype = {
              ...
              parseNodeBegin: function(e, t) {
                ...
                0 === this.currentIndent
                  ...
                  : "number" == typeof i.id
                  ? ((o[r] = {}), (o[r][i.id] = n))
                  : "Properties70" !== r && (o[r] = "PoseNode" === r ? [n] : n),
                  "number" == typeof i.id && (n.id = i.id),
                  "" !== i.name && (n.attrName = i.name),
                  "" !== i.type && (n.attrType = i.type),
                  this.pushStack(n);
              },
              ...
              parseNodeProperty: function(e, t, r) {
                ...
                if ("Properties70" !== i.name) {
                  ...
                  "Node" === a && (i.id = n),
                    a in i && Array.isArray(i[a])
                      ? i[a].push(n)
                      : "a" !== a
                      ? (i[a] = n)
                      : (i.a = n),
                    this.setCurrentProp(i, a),
                    "a" === a && "," !== n.slice(-1) && (i.a = h(n));
            ...
            (o.prototype = {
              ...
              parseNode: function(e, t) {
                ...
                var l = s.length > 0 ? s[0] : "",
                  ...
                  d = s.length > 2 ? s[2] : "";
                for (
                  r.singleProperty = 1 === n && e.getOffset() === a;
                  a > e.getOffset();
                  ...
                  0 === o.indexOf("Lcl ") && (o = o.replace("Lcl ", "Lcl_")),
                    ...
                    (i =
                      ...
                      0 === s.indexOf("Lcl_")
                        ...
                        : r.propertyList[4]),
                    (t[o] = { type: s, type2: c, flag: l, value: i });
                } else
                  void 0 === t[r.name]
                    ? "number" == typeof r.id
              ...
              parseProperty: function(e) {
                ...
                switch (t) {
                  ...
                  case "l":
                    ...
                    var o = new s(
                      new Zlib.Inflate(
                        new Uint8Array(e.getArrayBuffer(i))
                      ).decompress().buffer
                    );
                    switch (t) {
                      case "b":
          ...
          return new r(function(r, n) {
            ...
            s.addEventListener("load", function(e) {
              ...
              s.addEventListener("error", function(t) {
                n(new Error("Script request to " + e + " failed " + t)),
                  l(c),
                  a(o);
              }),
              (function(e) {
      ...
      function(e, t, r) {
        ...
        t.exports = AFRAME.registerComponent("animation-mixer", {
          schema: {
            ...
            loop: { default: "repeat", oneOf: Object.keys(n) },
          ...
          update: function(e) {
            if (e) {
              ...
              this.activeActions.forEach(function(e) {
                "duration" in r && t.duration && e.setDuration(t.duration),
                  "clampWhenFinished" in r &&
                    (e.clampWhenFinished = t.clampWhenFinished),
                  ("loop" in r || "repetitions" in r) &&
                    e.setLoop(n[t.loop], t.repetitions),
                  "timeScale" in r && e.setEffectiveTimeScale(t.timeScale);
              });
            }
          },
          stopAction: function() {
                ...
                for (
                  ...
                  if (i.name.match(o)) {
                    ...
                    (c.enabled = !0),
                      ...
                      c
                        .setLoop(n[t.loop], t.repetitions)
                  ...
                  this.loader.load(r, function(r) {
                    (e.model = r.scene),
                      e.model.traverse(function(e) {
                        if (e.isMesh) {
                          var t = e.material;
                          t.color && a.applyColorCorrection(t.color),
                            t.map && a.applyColorCorrection(t.map),
                            t.emissive && a.applyColorCorrection(t.emissive),
                            t.emissiveMap &&
                              a.applyColorCorrection(t.emissiveMap);
                        }
                      }),
              ...
              this.loaderPromise.then(function() {
                e.loader.load(a, function(e) {
                  (t.model = e.scene),
                    ...
                    r.setObject3D("mesh", t.model),
                    r.emit("model-loaded", { format: "gltf", model: t.model });
                });
              }));
          },
          remove: function() {
